...
export type FrameResult = { Ok: Frame } | { Err: Error };
export type GetCertificateResult = { Ok: Certificate } | { Err: Error };
export type GetCertificatesResult = { Ok: Array<Certificate> } | { Err: Error };
export type GetFramesResult = { Ok: Array<Frame> } | { Err: Error };
export type GetStorageResult = { Ok: Principal } | { Err: Error };
export type GetTagResult = { Ok: Tag } | { Err: Error };
export type GetTagsResult = { Ok: Array<Tag> } | { Err: Error };
export type LastStorageResult = { Ok: Principal } | { Err: Error };
...
export type UpdateResult = { Ok: string } | { Err: Error };
export type VerifyResult =
  | {
      Ok: { Frame: Frame } | { Certificate: Certificate };
    }
  | { Err: Error };
