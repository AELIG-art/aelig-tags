...
import {GetTagResult, FrameResult, NFT} from "../../declarations/backend/backend.did";
...
const Frame = ({tagId}: Props) => {
    ...
    return !isLoading ? <div>
        {
            nft ? <div><a href={nftToOpenSeaUrl(nft)} className="text-center">Check the NFT on OpenSea</a></div> : <div>
