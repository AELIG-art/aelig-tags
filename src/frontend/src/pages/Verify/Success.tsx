...
import {Certificate, Frame, NFTMetadata} from "../../declarations/backend/backend.did";
...
const Success = (props: {
    ...
    const [
        metadata,
        setMetadata
    ] = useState<undefined|NFTMetadata>();
    ...
    return isLoading ? <p>Loading…</p> : <div className="container d-flex flex-column justify-content-center text-break">
        {metadata ? <div className="mt-3 mb-3">
            <div className={"row"}>
